...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.0cd15c99.js").then((m) => m.default || m)
  }
];
...
const projectInfo_vue_vue_type_style_index_0_scoped_0c670be9_lang = "";
const _sfc_main$5 = {
  __name: "projectInfo",
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.fad1a021.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
