...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index.5297abb0.js").then((m) => m.default || m)
  }
];
...
const projectInfo_vue_vue_type_style_index_0_scoped_0d9883e7_lang = "";
const _sfc_main$5 = {
  __name: "projectInfo",
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.196540c0.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
