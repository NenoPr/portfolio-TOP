import { getCurrentInstance, version, defineComponent, computed, ref, h, resolveComponent, shallowRef, reactive, useSSRContext, mergeProps, createApp, toRef, isRef, unref, defineAsyncComponent, provide, onErrorCaptured, inject, nextTick, withCtx, createTextVNode } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/unctx/dist/index.mjs';
import { hasProtocol, isEqual, parseURL, joinURL } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/ufo/dist/index.mjs';
import { createError as createError$1, sendRedirect } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/h3/dist/index.mjs';
import { useHead, createHead as createHead$1 } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/@unhead/vue/dist/index.mjs';
import { renderDOMHead, debouncedRenderDOMHead } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/@unhead/dom/dist/index.mjs';
import { createMemoryHistory, createRouter } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/vue-router/dist/vue-router.node.mjs';
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderSuspense } from 'file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/vue/server-renderer/index.mjs';
...
const node_modules_nuxt_dist_head_runtime_lib_vueuse_head_plugin_mjs_D7WGfuP1A0 = defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp._useHead = useHead;
  {
    nuxtApp.ssrContext.renderMeta = async () => {
      const { renderSSRHead } = await import('file:///home/neno/WebProjects/The%20Odin%20Project%20Projects/portfolio-TOP/node_modules/@unhead/ssr/dist/index.mjs');
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index.0cd15c99.mjs').then((m) => m.default || m)
  }
];
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(projects), (project) => {
        _push(`<!--[--><div class="${ssrRenderClass([project.titleClass, "project-holder"])}" data-v-0c670be9><div class="project-details-name" data-v-0c670be9>${ssrInterpolate(project.title)}</div><div class="project-details-holder" data-v-0c670be9><div class="project-info-holder" data-v-0c670be9><div class="font-bold text-xl" data-v-0c670be9>Description:</div><p class="project-details-description" data-v-0c670be9>${ssrInterpolate(project.desc)}</p></div><div class="project-tools-holder" data-v-0c670be9><p class="project-details-tool-header" data-v-0c670be9>Tools Used</p><div class="project-details-tools-holder" data-v-0c670be9><!--[-->`);
        ssrRenderList(project.tools, (item) => {
          _push(`<div class="project-details-tool" data-v-0c670be9><div class="project-details-tool-name" data-v-0c670be9>${ssrInterpolate(item.tool)}</div><div class="project-details-logo" data-v-0c670be9><img${ssrRenderAttr("src", `img/${item.image}`)}${ssrRenderAttr("alt", item.tool)} data-v-0c670be9></div></div>`);
        });
        _push(`<!--]--></div></div></div><a${ssrRenderAttr("href", `${project.webLink}`)} target="_blank" rel="noreferrer noopener" class="tryit-link" data-v-0c670be9>Try it Out</a><div class="project-images-slider-container" data-v-0c670be9><div class="project-images-left" data-v-0c670be9>&lt;</div><div class="project-images-holder" data-v-0c670be9><img${ssrRenderAttr("src", "img/" + project.image)} class="project-details-image" alt="" data-v-0c670be9><img${ssrRenderAttr("src", "img/" + project.image)} class="project-details-image" alt="" data-v-0c670be9></div><div class="project-images-right" data-v-0c670be9>&gt;</div></div></div><div class="separator" data-v-0c670be9></div><!--]-->`);
      });
      _push(`<!--]-->`);
    };
  }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-0c670be9"]]);
const _sfc_main$4 = {};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.fad1a021.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$2 as a, __nuxt_component_1 as b, __nuxt_component_2 as c, __nuxt_component_3 as d, entry$1 as default, useNuxtApp as u };
